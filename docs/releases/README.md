...
| --- | --- | --- |
| v1.9.4 | Current | Recommended published release |
| v1.9.3 | Superseded | Upgrade for universal controller management and persistent device memory |
| v1.9.2 | **Deprecated** | **Do not use for new setup; upgrade to v1.9.4+** |
| v1.9.1 | **Deprecated** | **Do not use Automatic Repair; upgrade to v1.9.4+** |
| v1.9.0 | **Deprecated** | **Do not use; upgrade to v1.9.4+** |
