...
| --- | --- | --- |
| v2.3.2 | Current | Battlefield 6 / Helicopter starter profile |
| v2.3.1 | Historical stable | Adaptive Response correctness and Response Lab; use v2.3.2 for the current release |
| v2.3.0 | Historical stable | Adaptive Response baseline; use v2.3.2 for the current release |
| v2.2.0 | Historical stable | Bumpless Curve / Mapping Transition Smoothing baseline; use v2.3.2 for the current release |
| v2.1.6 | Historical stable | Input Learning & Quick Map correction baseline; use v2.3.2 for the current release |
| v2.1.5 | Historical stable | Input Learning, Quick Assign & vJoy capacity correction baseline; use v2.3.2 for the current release |
| v2.1.4 | Historical stable | Runtime Responsiveness, GUI Efficiency & unloadable page lifecycle baseline; use v2.3.2 for the current release |
