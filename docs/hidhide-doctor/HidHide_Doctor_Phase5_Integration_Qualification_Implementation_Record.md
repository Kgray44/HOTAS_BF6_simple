...
| 17. External tester campaign | The historical R2 kit remains `C:\hotas-builds\HidHideDoctor-Phase5-ExternalQualification-Kit-2.6.2-R2`, with 1,395 receipt-manifest entries and kit-manifest SHA-256 `E9E86227BC1713D1D29AC031FE5171AF28D855F525CCEC8356948A49DAEF3E94`. The current R9 handoff kit is `C:\hotas-builds\HidHideDoctor-Phase5-ExternalQualification-Kit-2.6.2-R9`: it has 1,392 independently verified kit-manifest entries, kit-manifest SHA-256 `668ED550180BA587CE1AE78296E0824B8DCF41F389DF0EE96ACFCC19EABDC104`, and a candidate receipt matching R9's stage-manifest SHA-256 `12E0229FA5F8177DB44AE0BB1D5578BD7A3CD3F7084E5D35F702727745C4BEE7` plus Doctor/helper hashes. It declares `repairAuthorized: false` and includes the self-contained candidate, user/tester guide, owner worksheet, external matrix, candidate receipt, and receipt instructions. An external tester has not yet run either kit. |
...
| 36b. R9 documentation-tip local CTest rerun | On documentation-only tip `55d15ab3e08f09ab30482b468efa2983b4e37b81`, the existing configured `C:\\hotas-builds\\hidhide-doctor-phase5-addendum1` build completed a fresh sequential CTest run: **22/22 passed** in **286.47 seconds** with a 300-second per-test bound. This included domain, deep-repair containment, standalone startup, hostile-path, layout, mapping-core, launcher, crash-diagnostics, controller-readiness, updater-manifest, backend-startup, every HOTAS theme, QML startup, and theme-manager coverage. The commit changes qualification documentation only, so no product binary was rebuilt or staged; this is current-source automated evidence, not native interaction, physical-hardware, or release evidence. |
