...
| Real Windows scaling, keyboard navigation, accessibility names/roles, and in-app control-style review | A. LOCAL RC BLOCKER | Partially Qualified | The owner reported the requested native display review looked good, but scale-by-scale/page-by-page capture, keyboard-only traversal, and accessibility-name/role evidence remain required. Screen-reader remains explicitly unqualified unless actually exercised. |
