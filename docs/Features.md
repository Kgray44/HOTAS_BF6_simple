...
- Flight Deck Settings includes Guidance level. Guided starts with concise task explanations and on-demand advanced disclosures; Full starts with the same controls and technical detail expanded. The choice never changes mappings, Profiles, Device Rigs, automation, repair authority, themes, text size, or activation.
