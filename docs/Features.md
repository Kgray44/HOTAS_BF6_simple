...
- Flight Deck Settings includes Guidance level. Guided gives Overview, Devices, Profiles, Axes, Buttons, Automation, and Signal Flow a highlighted page-local next decision with advanced detail on demand; Full uses compact editing context with the same controls and untouched Overview/Devices technical detail expanded. The choice never changes mappings, Profiles, Device Rigs, automation, repair authority, themes, text size, or activation.
