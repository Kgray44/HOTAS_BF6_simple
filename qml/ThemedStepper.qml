...
Item {
    ...
    RowLayout { anchors.fill: parent; anchors.margins: 2; spacing: 2
        ...
        Text { Layout.fillWidth: true; Layout.minimumWidth: 32; text: control.value; horizontalAlignment: Text.AlignHCenter; color: legacy ? "#e3eeee" : theme.text; font.bold: true; font.pixelSize: theme.scale(11); font.family: theme.telemetryFont }
