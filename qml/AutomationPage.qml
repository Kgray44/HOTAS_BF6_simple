...
Item {
    ...
    component ActionButton: Rectangle {
        ...
        Text { id: buttonLabel; anchors.centerIn: parent; text: parent.label; color: parent.destructive ? root.dangerColor : (parent.subdued ? root.textColor : "#081013"); font.pixelSize: themeTokens.scale(10); font.bold: true; font.family: root.displayFont }
    ...
    component EditorTextField: TextField {
        ...
        font.pixelSize: themeTokens.scale(11); font.family: root.displayFont
    ...
    component EditorCombo: ComboBox {
        id: combo
        implicitHeight: 34; leftPadding: 10; rightPadding: 28; font.pixelSize: themeTokens.scale(10); font.family: root.displayFont
        ...
        indicator: Text { x: combo.width - width - 9; y: (combo.height - height) / 2; text: "⌄"; color: root.mutedColor; font.pixelSize: themeTokens.scale(15) }
        delegate: ItemDelegate {
            width: combo.width; implicitHeight: 32; highlighted: combo.highlightedIndex === index
            contentItem: Text { text: combo.textAt(index); leftPadding: 10; rightPadding: 10; color: parent.highlighted ? root.textColor : root.mutedColor; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.pixelSize: themeTokens.scale(10); font.family: root.displayFont }
    ...
    component EditorSpin: SpinBox {
        id: spin
        implicitHeight: 34; editable: true; font.pixelSize: themeTokens.scale(10)
    ...
    component EditorSwitch: Switch {
        ...
        contentItem: Text { text: toggle.text; color: root.mutedColor; font.pixelSize: themeTokens.scale(10); font.bold: true; verticalAlignment: Text.AlignVCenter; font.family: root.displayFont }
    }
        ...
        Column {
            ...
            RowLayout {
                ...
                ColumnLayout { Layout.fillWidth: true; spacing: 4
                    Text { text: root.topGun ? "AUTOMATION  /  FLIGHT LOGIC" : "Automation"; color: root.textColor; font.pixelSize: themeTokens.scale(root.topGun ? 40 : 26); font.bold: true; font.family: root.displayFont; style: root.topGun ? Text.Outline : Text.Normal; styleColor: "#8e3321" }
                    Text { text: "Compiled deterministic control rules · evaluated once per physical report"; color: root.mutedColor; font.pixelSize: themeTokens.scale(12); font.family: root.displayFont }
                }
            ...
            ThemedPanel {
                ...
                GridLayout {
                    ...
                    ColumnLayout { Layout.fillWidth: true; spacing: 2
                        Text { text: "AUTOMATION ENGINE"; color: root.mutedColor; font.pixelSize: themeTokens.scale(9); font.bold: true; font.family: root.displayFont }
                        Text { text: backendObject.automationEngineEnabled ? (root.topGun ? "ARMED" : "ENABLED") : "DISABLED"; color: backendObject.automationEngineEnabled ? root.readyColor : root.dangerColor; font.pixelSize: themeTokens.scale(17); font.bold: true; font.family: root.displayFont }
                    }
                    ...
                    Repeater {
                        ...
                        delegate: ColumnLayout { Layout.fillWidth: true; spacing: 2
                            Text { text: modelData.label; color: root.mutedColor; font.pixelSize: themeTokens.scale(9); font.bold: true; font.family: root.displayFont }
                            Text { text: modelData.value; color: modelData.tone; font.pixelSize: themeTokens.scale(17); font.bold: true; font.family: root.telemetryFont }
                        }
                    }
                }
            }
            ThemedPanel {
                ...
                Column { anchors.centerIn: parent; width: Math.min(parent.width - 48, 560); spacing: 8
                    Text { anchors.horizontalCenter: parent.horizontalCenter; text: "NO AUTOMATIONS"; color: root.textColor; font.pixelSize: themeTokens.scale(17); font.bold: true; font.family: root.displayFont }
                    Text { width: parent.width; horizontalAlignment: Text.AlignHCenter; wrapMode: Text.WordWrap; text: "Automation rules modify controller behavior from supported buttons, axes, POV states, and profiles. New rules begin disabled until you save a valid configuration."; color: root.mutedColor; font.pixelSize: themeTokens.scale(11) }
                    ...
                    delegate: ThemedPanel {
                        ...
                        ColumnLayout {
                            ...
                            RowLayout { Layout.fillWidth: true
                                ColumnLayout { Layout.fillWidth: true; spacing: 2
                                    Text { text: modelData.name.toUpperCase(); color: root.textColor; font.pixelSize: themeTokens.scale(14); font.bold: true; font.family: root.displayFont; elide: Text.ElideRight; Layout.fillWidth: true }
                                    Text { text: root.ruleState(modelData); color: root.ruleStateColor(modelData); font.pixelSize: themeTokens.scale(9); font.bold: true; font.family: root.displayFont }
                                }
                            ...
                            RowLayout { Layout.fillWidth: true
                                Text { text: modelData.enabled ? "Changes are active after Save" : "This automation is disabled"; color: root.mutedColor; font.pixelSize: themeTokens.scale(9); font.family: root.displayFont }
                                Item { Layout.fillWidth: true }
                                Text { text: "OPEN ›"; color: root.accentColor; font.pixelSize: themeTokens.scale(9); font.bold: true; font.family: root.displayFont }
                            }
                            Text { text: modelData.behaviorLabel; color: root.accentColor; font.pixelSize: themeTokens.scale(9); font.bold: true; font.family: root.telemetryFont }
                            Text { text: "WHEN"; color: root.faintColor; font.pixelSize: themeTokens.scale(9); font.bold: true; font.family: root.displayFont }
                            Text { text: modelData.conditions.length ? modelData.conditionSummary : "Nothing selected yet"; color: root.textColor; font.pixelSize: themeTokens.scale(11); wrapMode: Text.WordWrap; Layout.fillWidth: true }
                            Text { text: "DO"; color: root.faintColor; font.pixelSize: themeTokens.scale(9); font.bold: true; font.family: root.displayFont }
                            Text { text: modelData.actions.length ? modelData.actionSummary : "Nothing selected yet"; color: modelData.actions.length ? root.accentColor : root.warningColor; font.pixelSize: themeTokens.scale(11); wrapMode: Text.WordWrap; Layout.fillWidth: true }
                            Text { visible: modelData.healthMessage.length > 0; text: modelData.healthMessage; color: root.dangerColor; font.pixelSize: themeTokens.scale(10); wrapMode: Text.WordWrap; Layout.fillWidth: true }
    ...
    Flickable {
        ...
        Column {
            ...
            RowLayout { width: parent.width
                ...
                ColumnLayout { Layout.fillWidth: true; spacing: 2
                    Text { text: root.topGun ? "AUTOMATION  /  RULE BUILDER" : "Automation"; color: root.textColor; font.pixelSize: themeTokens.scale(root.topGun ? 32 : 24); font.bold: true; font.family: root.displayFont; style: root.topGun ? Text.Outline : Text.Normal; styleColor: "#8e3321" }
                    Text { text: "Changes take effect after Save. The running mapper keeps the last saved automation."; color: root.mutedColor; font.pixelSize: themeTokens.scale(11); font.family: root.displayFont }
                }
                Text { text: root.draft.enabled ? "ENABLED ON SAVE" : "DISABLED"; color: root.draft.enabled ? root.readyColor : root.warningColor; font.pixelSize: themeTokens.scale(10); font.bold: true; font.family: root.displayFont }
            }
            ThemedPanel {
                ...
                ColumnLayout {
                    ...
                    Text { text: "BASIC SETTINGS"; color: root.accentColor; font.pixelSize: themeTokens.scale(12); font.bold: true; font.family: root.displayFont }
                    GridLayout {
                        Layout.fillWidth: true; columns: width >= 650 ? 2 : 1; columnSpacing: 14; rowSpacing: 10
                        ColumnLayout { Layout.fillWidth: true
                            Text { text: "AUTOMATION NAME"; color: root.mutedColor; font.pixelSize: themeTokens.scale(9); font.bold: true }
            ...
            ThemedPanel {
                ...
                ColumnLayout {
                    ...
                    ColumnLayout { Layout.fillWidth: true; spacing: 7
                        Text { text: "WHEN SHOULD THIS HAPPEN?"; color: root.accentColor; font.pixelSize: themeTokens.scale(15); font.bold: true; font.family: root.displayFont }
                        RowLayout { Layout.fillWidth: true
                            Text { text: "This automation runs"; color: root.mutedColor; font.pixelSize: themeTokens.scale(10); Layout.fillWidth: true }
                        ...
                        Text { text: "Choose what the automation should react to."; color: root.mutedColor; font.pixelSize: themeTokens.scale(10) }
                    }
                    Text { visible: root.isAlwaysActive(root.draft); text: "This automation remains active whenever it is enabled."; color: root.readyColor; font.pixelSize: themeTokens.scale(11); wrapMode: Text.WordWrap; Layout.fillWidth: true }
                    ThemedPanel {
                        ...
                        ColumnLayout {
                            ...
                            Text { text: "Nothing selected yet."; color: root.textColor; font.pixelSize: themeTokens.scale(12); font.bold: true; font.family: root.displayFont }
                            Text { text: "Choose what this automation should react to:"; color: root.mutedColor; font.pixelSize: themeTokens.scale(10) }
                        ...
                        delegate: ColumnLayout {
                            ...
                            ThemedPanel {
                                ...
                                ColumnLayout {
                                    ...
                                    RowLayout { Layout.fillWidth: true
                                        Text { text: (conditionCard.conditionIndex + 1) + " · " + root.requirementSummary(modelData); color: root.textColor; font.pixelSize: themeTokens.scale(11); font.bold: true; font.family: root.displayFont; Layout.fillWidth: true; elide: Text.ElideRight }
                                    ...
                                    Flow {
                                        ...
                                        Text { visible: root.isMultiPress(modelData); text: "times"; color: root.mutedColor; font.pixelSize: themeTokens.scale(10); height: 34; verticalAlignment: Text.AlignVCenter }
                                        ...
                                        Text { visible: root.isMultiPress(modelData); text: "ms window"; color: root.mutedColor; font.pixelSize: themeTokens.scale(10); height: 34; verticalAlignment: Text.AlignVCenter }
                                        ...
                                        Text { visible: root.isLongPress(modelData); text: "ms hold"; color: root.mutedColor; font.pixelSize: themeTokens.scale(10); height: 34; verticalAlignment: Text.AlignVCenter }
                                        ...
                                        Text { visible: Number(modelData.type) === 3 || Number(modelData.type) === 4; text: Number(modelData.type) === 3 ? "and" : "to"; color: root.mutedColor; font.pixelSize: themeTokens.scale(10); height: 34; verticalAlignment: Text.AlignVCenter }
                                    ...
                                    RowLayout { visible: root.requirementKind(modelData) === 2; Layout.fillWidth: true
                                        Text { text: "Input stability"; color: root.mutedColor; font.pixelSize: themeTokens.scale(9); font.bold: true }
                                        ...
                                        Text { text: "Ignore tiny movements below this amount."; color: root.faintColor; font.pixelSize: themeTokens.scale(9); Layout.fillWidth: true; wrapMode: Text.WordWrap }
                                    }
                                }
                            }
                        }
            ...
            ThemedPanel {
                ...
                ColumnLayout {
                    id: behaviorContent
                    anchors.fill: parent; anchors.margins: 14; spacing: 8
                    Text { text: "HOW SHOULD THIS AUTOMATION BEHAVE?"; color: root.accentColor; font.pixelSize: themeTokens.scale(15); font.bold: true; font.family: root.displayFont }
                    RowLayout { Layout.fillWidth: true
            ...
            ThemedPanel {
                ...
                ColumnLayout {
                    ...
                    anchors.fill: parent; anchors.margins: 14; spacing: 12
                    ColumnLayout { Layout.fillWidth: true; spacing: 2
                        Text { text: "WHAT SHOULD IT DO?"; color: root.accentColor; font.pixelSize: themeTokens.scale(15); font.bold: true; font.family: root.displayFont }
                        Text { text: "Choose the controller behavior to apply whenever this automation matches."; color: root.mutedColor; font.pixelSize: themeTokens.scale(10) }
                    }
                    Text { visible: (root.draft.actions || []).length === 0; text: "Nothing selected yet."; color: root.warningColor; font.pixelSize: themeTokens.scale(11) }
                    Repeater {
                        ...
                        delegate: ThemedPanel {
                            ...
                            ColumnLayout {
                                ...
                                anchors.fill: parent; anchors.margins: 12; spacing: 9
                                RowLayout { Layout.fillWidth: true
                                    Text { text: (actionCard.actionIndex + 1) + " · " + root.effectSummary(modelData); color: root.textColor; font.pixelSize: themeTokens.scale(11); font.bold: true; font.family: root.displayFont; Layout.fillWidth: true; elide: Text.ElideRight }
                                ...
                                ColumnLayout {
                                    ...
                                    RowLayout { visible: Number(modelData.type) === 0 || Number(modelData.type) === 1; Layout.fillWidth: true
                                        Text { text: "Virtual button"; color: root.mutedColor; font.pixelSize: themeTokens.scale(10) }
                                    ...
                                    RowLayout { visible: Number(modelData.type) === 2 || Number(modelData.type) === 3; Layout.fillWidth: true
                                        Text { text: "Profile"; color: root.mutedColor; font.pixelSize: themeTokens.scale(10) }
                                    ...
                                    RowLayout { visible: Number(modelData.type) === 4 || Number(modelData.type) === 5 || Number(modelData.type) === 7; Layout.fillWidth: true
                                        Text { text: "Target axis"; color: root.mutedColor; font.pixelSize: themeTokens.scale(10) }
                                        ...
                                        Text { text: Number(modelData.type) === 5 ? "by" : "to"; color: root.mutedColor; font.pixelSize: themeTokens.scale(10) }
                                    ...
                                    RowLayout { visible: Number(modelData.type) === 6; Layout.fillWidth: true
                                        Text { text: "Target axis"; color: root.mutedColor; font.pixelSize: themeTokens.scale(10) }
                                        EditorCombo { Layout.preferredWidth: 148; model: root.axisChoices; currentIndex: modelData.targetAxis; onActivated: function(choiceIndex) { root.updateAction(actionCard.actionIndex, "targetAxis", choiceIndex) } }
                                        Text { text: "minimum"; color: root.mutedColor; font.pixelSize: themeTokens.scale(10) }
                                        ...
                                        Text { text: "maximum"; color: root.mutedColor; font.pixelSize: themeTokens.scale(10) }
                                    ...
                                    RowLayout { visible: Number(modelData.type) === 8; Layout.fillWidth: true
                                        Text { text: "Source"; color: root.mutedColor; font.pixelSize: themeTokens.scale(10) }
                                        ...
                                        Text { text: "Target"; color: root.mutedColor; font.pixelSize: themeTokens.scale(10) }
                                    ...
                                    RowLayout { visible: Number(modelData.type) === 9; Layout.fillWidth: true
                                        Text { text: "Target"; color: root.mutedColor; font.pixelSize: themeTokens.scale(10) }
                                        EditorCombo { Layout.preferredWidth: 132; model: root.axisChoices; currentIndex: modelData.targetAxis; onActivated: function(choiceIndex) { root.updateAction(actionCard.actionIndex, "targetAxis", choiceIndex) } }
                                        Text { text: "follows"; color: root.mutedColor; font.pixelSize: themeTokens.scale(10) }
                                        EditorCombo { Layout.preferredWidth: 132; model: root.axisChoices; currentIndex: modelData.sourceAxis; onActivated: function(choiceIndex) { root.updateAction(actionCard.actionIndex, "sourceAxis", choiceIndex) } }
                                        EditorCombo { Layout.preferredWidth: 158; model: root.sourceStages; currentIndex: modelData.sourceStage; onActivated: function(choiceIndex) { root.updateAction(actionCard.actionIndex, "sourceStage", choiceIndex) } }
                                    ...
                                    RowLayout { visible: Number(modelData.type) === 16; Layout.fillWidth: true
                                        ...
                                        Text { text: "Preset"; color: root.mutedColor; font.pixelSize: themeTokens.scale(10) }
                                    ...
                                    RowLayout { visible: root.isTap(modelData); Layout.fillWidth: true
                                        Text { text: "Virtual button"; color: root.mutedColor; font.pixelSize: themeTokens.scale(10) }
                                        EditorSpin { Layout.preferredWidth: 92; from: 1; to: 128; value: modelData.virtualButton; onValueModified: root.updateAction(actionCard.actionIndex, "virtualButton", value) }
                                        Text { text: "Tap duration (ms)"; color: root.mutedColor; font.pixelSize: themeTokens.scale(10) }
            ...
            ThemedPanel {
                ...
                ColumnLayout {
                    ...
                    Text { text: "RULE SUMMARY"; color: root.accentColor; font.pixelSize: themeTokens.scale(14); font.bold: true; font.family: root.displayFont }
                    Text { text: root.ruleSummary(); color: root.textColor; font.pixelSize: themeTokens.scale(16); font.weight: Font.DemiBold; font.family: root.displayFont; wrapMode: Text.WordWrap; Layout.fillWidth: true }
                }
            }
            ThemedPanel {
                ...
                ColumnLayout {
                    ...
                    RowLayout { Layout.fillWidth: true
                        ColumnLayout { Layout.fillWidth: true; spacing: 2
                            Text { text: "ADVANCED"; color: root.accentColor; font.pixelSize: themeTokens.scale(12); font.bold: true; font.family: root.displayFont }
                            Text { text: "Timing and conflict handling."; color: root.mutedColor; font.pixelSize: themeTokens.scale(10) }
                        }
                    ...
                    ColumnLayout { visible: root.advancedOpen; Layout.fillWidth: true; spacing: 8
                        RowLayout { Layout.fillWidth: true
                            Text { text: "Priority"; color: root.textColor; font.pixelSize: themeTokens.scale(11); font.bold: true; Layout.preferredWidth: 110 }
                            ...
                            Text { text: "When automations force the same axis, the higher priority wins. Equal priorities use saved order."; color: root.faintColor; font.pixelSize: themeTokens.scale(9); wrapMode: Text.WordWrap; Layout.fillWidth: true }
                        }
                        RowLayout { visible: root.behaviorMode(root.draft) === 2; Layout.fillWidth: true
                            Text { text: "Active duration"; color: root.textColor; font.pixelSize: themeTokens.scale(11); font.bold: true; Layout.preferredWidth: 170 }
                            ...
                            Text { text: "ms · Each trigger restarts this short active window."; color: root.faintColor; font.pixelSize: themeTokens.scale(9); Layout.fillWidth: true; wrapMode: Text.WordWrap }
                        }
                        Repeater {
                            ...
                            delegate: RowLayout {
                                ...
                                Text { text: "Maximum time between presses"; color: root.textColor; font.pixelSize: themeTokens.scale(11); font.bold: true; Layout.preferredWidth: 170 }
                                ...
                                Text { text: "ms · Button " + modelData.button + " sequence gap."; color: root.faintColor; font.pixelSize: themeTokens.scale(9); Layout.fillWidth: true; wrapMode: Text.WordWrap }
                            }
                        }
                        Repeater {
                            model: root.draft.conditions || []
                            delegate: RowLayout {
                                ...
                                Text { text: "Long-press duration"; color: root.textColor; font.pixelSize: themeTokens.scale(11); font.bold: true; Layout.preferredWidth: 170 }
                                ...
                                Text { text: "ms · Button " + modelData.button + " must stay held continuously."; color: root.faintColor; font.pixelSize: themeTokens.scale(9); Layout.fillWidth: true; wrapMode: Text.WordWrap }
                            }
                        }
                        Repeater {
                            model: root.draft.actions || []
                            delegate: RowLayout {
                                ...
                                Text { text: "Virtual button tap duration"; color: root.textColor; font.pixelSize: themeTokens.scale(11); font.bold: true; Layout.preferredWidth: 170 }
                                ...
                                Text { text: "ms · Virtual button " + modelData.virtualButton + "."; color: root.faintColor; font.pixelSize: themeTokens.scale(9); Layout.fillWidth: true; wrapMode: Text.WordWrap }
                            }
                        }
                    }
                }
            ...
            ThemedPanel {
                ...
                ColumnLayout {
                    id: saveContent
                    anchors.fill: parent; anchors.margins: 14; spacing: 10
                    Text { visible: String(root.draft.name || "").trim().length === 0; text: "Give this automation a name."; color: root.warningColor; font.pixelSize: themeTokens.scale(10); Layout.fillWidth: true }
                    Text { visible: !root.isAlwaysActive(root.draft) && (root.draft.conditions || []).length === 0; text: "Choose when this automation should run, or select All the time."; color: root.warningColor; font.pixelSize: themeTokens.scale(10); Layout.fillWidth: true }
                    Text { visible: !root.isAlwaysActive(root.draft) && (root.draft.conditions || []).some(function(requirement) { return !root.requirementReady(requirement) }); text: "Finish each requirement before saving."; color: root.warningColor; font.pixelSize: themeTokens.scale(10); Layout.fillWidth: true }
                    Text { visible: (root.draft.actions || []).length === 0; text: "Add at least one effect."; color: root.warningColor; font.pixelSize: themeTokens.scale(10); Layout.fillWidth: true }
                    Text { visible: (root.draft.actions || []).some(function(effect) { return !root.effectReady(effect) }); text: "Choose what each effect should do."; color: root.warningColor; font.pixelSize: themeTokens.scale(10); Layout.fillWidth: true }
                    Text { visible: backendObject.automationValidationMessage.length > 0; text: backendObject.automationValidationMessage; color: root.dangerColor; font.pixelSize: themeTokens.scale(11); wrapMode: Text.WordWrap; Layout.fillWidth: true }
                    RowLayout { Layout.fillWidth: true
                        ...
                        Text { text: root.draftDirty ? "UNSAVED CHANGES" : "SAVED DRAFT"; color: root.draftDirty ? root.warningColor : root.mutedColor; font.pixelSize: themeTokens.scale(9); font.bold: true; font.family: root.telemetryFont; Layout.leftMargin: 8 }
                        Item { Layout.fillWidth: true }
    ...
    Dialog {
        ...
        contentItem: ColumnLayout { width: 350; spacing: 14
            Text { Layout.fillWidth: true; wrapMode: Text.WordWrap; text: "This Automation has unsaved editor changes. The active compiled rule will remain unchanged."; color: root.textColor; font.pixelSize: themeTokens.scale(12) }
            RowLayout { Layout.fillWidth: true; Item { Layout.fillWidth: true }
    ...
    Dialog {
        ...
        contentItem: ColumnLayout { width: 350; spacing: 14
            Text { Layout.fillWidth: true; wrapMode: Text.WordWrap; text: "Delete this Automation rule? This removes its saved configuration and compiled runtime entry."; color: root.textColor; font.pixelSize: themeTokens.scale(12) }
            RowLayout { Layout.fillWidth: true; Item { Layout.fillWidth: true }
